...
1. Ask the agent that produced your report to present it with Sillage. It supplies its existing report/context and owns listening before opening the reader; there is no manual respondent setup for you. Contents on the left is collapsible and starts closed on narrow screens, without a persisted preference. The report stays central; chat has its own panel on the right.
