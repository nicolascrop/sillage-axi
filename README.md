...
Requires **Node.js 22.13+** (or 24+) and npm. Node 22 may print a `node:sqlite` ExperimentalWarning; it does not mean that installation or tests failed. From this directory:
