  ...
  try {
    ...
    if (['home', 'context', 'document', 'blocks', 'block', 'threads', 'thread'].includes(name)) {
      ...
      if (name === 'home') {
        ...
        else help.push(hint(name === 'blocks' ? commandsImportExample() : 'sillage question --revision <id> --block <id> --quote <exact-text> --text <question> --key <client-key>'));
...
function commandsImportExample() {
  return 'sillage import --file <path> --title <title> --key <operation-key> --expected null';
}
